...
| method | macro-F1 | % agreement | notes |
|:-------|:--------:|:-----------:|:------|
| HF twitter-roberta (fine-tuned) | **0.777** | **77.0%** | trained on this domain |
| **sentimentai-py (e5-small)** | **0.615** | **71.4%** | multilingual, ~100 languages |
| vaderSentiment | 0.473 | 55.9% | weak on neutral; airline vocab mismatch |
| TextBlob | 0.349 | 43.3% | general-purpose, not tuned |

**When to use each:**

- **twitter-roberta**: highest accuracy on English Twitter; 25× slower on CPU; no multilingual support; ~500 MB download; not tunable.
- **sentimentai-py**: best accuracy across languages; tunable poles; calibrated confidence; auditable provenance; matches the R package bit-for-bit.
- **vaderSentiment / TextBlob**: when you need sub-millisecond speed and accuracy is secondary.
