...
(95% CI [+0.134, +0.199] — entirely above zero). On a 6-language synthetic benchmark,
`e5-base` reaches macro-F1 0.827 overall; the Twitter model can't score outside English,
and VADER collapses to F1 = 0.27 on German. All benchmarks run locally — no API calls,
no data sent anywhere. See the [Benchmarks](#benchmarks) section for full results and CIs.
</div>
