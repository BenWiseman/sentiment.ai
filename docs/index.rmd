...
require(reticulate)
use_condaenv("r-sentiment-ai", required = TRUE)
...
5) **Speed** 
On large datasets, `sentimenmt.ai` can harness the power of a GPU to achieve a significant speedup compared to traditional sentiment analysis methods. 
